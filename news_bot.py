...
**یادآوری: تمام پاسخ‌ها و تحلیل‌ها را به زبان فارسی بنویس.**
"""
...
- **تحت هیچ شرایطی به انگلیسی ننویس.**
- **همه فیلدهای JSON باید به فارسی پر شوند.**
...
سپس یک **تحلیل جامع** به **فارسی** بنویس که شامل:
...
{{
  ...
  "analysis": "تحلیل جامع بازار طلا به فارسی..."
}}
"""
...
۲. تاثیر مستقیم این داده بر قیمت طلا را به **فارسی** تحلیل کن
